...
class FormYearPicker extends StatefulWidget {
  final Key? key;
  // 标签
  final String label;
  // 是否是必选项
  ...
  @override
  State<StatefulWidget> createState() => FormYearPickerState();
}

class FormYearPickerState extends State<FormYearPicker> {
  DateTime? _currTime;
  String? _errText;
      ...
      child: FormItem(
        ...
        child: Container(
          ...
          child: Row(
            ...
            children: [
              Text(_currTime != null ? "${_currTime!.year}年" : "",
                  style: _enabled
                      ? FormStyle.textStyle
