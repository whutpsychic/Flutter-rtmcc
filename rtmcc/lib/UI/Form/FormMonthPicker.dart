...
class FormMonthPicker extends StatefulWidget {
  final Key? key;
  // 标签
  final String label;
  // 是否是必选项
  ...
  @override
  State<StatefulWidget> createState() => FormMonthPickerState();
}

class FormMonthPickerState extends State<FormMonthPicker> {
  DateTime? _currTime;
  String? _errText;
        ...
        child: Container(
          ...
          child: Row(
            ...
            children: [
              Text(
                  _currTime != null
                      ? "${_currTime!.year}年${_currTime!.month}月"
                      : "",
                  style: _enabled
                      ? FormStyle.textStyle
